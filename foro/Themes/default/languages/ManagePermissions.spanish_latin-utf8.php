...
$txt['permissions_profiles_desc'] = 'Los permisos de perfiles se asignan para administrar fácilmente la configuración de seguridad. Desde esta zona se pueden crear, editar y borrar permisos de perfiles.';
...
$txt['permissions_profile_reply_only'] = 'Sólo Responder';
...
$txt['permissions_board_desc'] = '<strong>Nota:</strong> Cambiar estos permisos del foro afectará a todos los foros actualmente asignando el permiso "Predeterminado" del perfil. Los foros que no utilicen el perfil "predeterminado" no se verán afectados por los cambios a esta página.';
...
$txt['permissions_view_classic'] = 'Clásico';
...
$txt['permissionhelp_pm_read'] = 'Este permiso le permite a los usuarios acceder a la sección de Mensajes Personales para leer sus mensajes. Sin este permiso, un usuario no puede enviar mensajes personales.';
$txt['permissionname_pm_send'] = 'Enviar mensajes personales';
$txt['permissionhelp_pm_send'] = 'Envía mensajes personales a otros usuarios registrados. Necesita del permiso \'Leer mensajes personales\'.';
...
$txt['permissionhelp_admin_forum'] = 'Este permiso le permite a un usuario:<ul class="normallist"><li>cambiar la configuración del foro, la base de datos y el tema</li><li>manejar paquetes</li><li>usar las herramientas de mantenimiento del foro y la base de datos</li><li>ver los registros de errores y moderación</li></ul> Usa este permiso con cuidado ya que es muy poderoso.';
...
$txt['permissionhelp_manage_smileys'] = 'Este permite accesar al centro de smileys. En el centro de smileys puedes agregar, editar y emilinar smileys y conjuntos de smileys. Si has habilitado los iconos de mensaje personalizados también podrás agregar o editar los iconos de mensaje con este permiso.';
...
$txt['permissionname_access_mod_center'] = 'Acceda al centro de moderación';
$txt['permissionhelp_access_mod_center'] = 'Con esta licencia, los miembros de este grupo pueden acceder al centro de la moderación, donde tendrán acceso a la funcionalidad para facilitar la moderación. Nota que esto no es en sí conceder privilegios de moderación.';
...
$txt['permissiongroup_approval'] = 'Moderación Mensaje';
$txt['permissionname_approve_posts'] = 'Aprobar los artículos en espera de moderación';
$txt['permissionhelp_approve_posts'] = 'Este permiso permite a un usuario aprobar todos los artículos no aprobados en un foro.';
$txt['permissionname_post_unapproved_replies'] = 'Respuestas no autorizadas en mensajes';
$txt['permissionhelp_post_unapproved_replies'] = 'Este permiso permite a un usuario enviar sus respuestas a un tema en especifico, sus respuestas no se mostrarán hasta que sea aprobado por un moderador.';
...
$txt['permissionhelp_post_unapproved_topics'] = 'Este permiso permite a un usuario enviar un tema nuevo que va a requerir la aprobación antes de ser mostrado.';
$txt['permissionname_post_unapproved_attachments'] = 'Adjuntos no aprobados en mensajes';
$txt['permissionhelp_post_unapproved_attachments'] = 'Este permiso permite a los usuarios adjuntar archivos a sus mensajes, los archivos deberán de ser aprobados por un moderador antes de que puedan ser vistos por otros usuarios.';
...
$txt['permissiongroup_simple_use_pm_system'] = 'Póngase en contacto con los miembros mediante el sistema de mensajería personal';
...
$txt['permissionname_simple_profile_identity_own'] = 'Editar configuración de su cuenta';
$txt['permissionname_simple_profile_identity_any'] = 'Editar configuración de otras cuentas';
$txt['permissionname_simple_profile_extra_own'] = 'Editar más opciones en su perfil';
$txt['permissionname_simple_profile_extra_any'] = 'Editar más opciones en perfil de otros';
$txt['permissionname_simple_profile_title_own'] = 'Elegir tu título personalizado';
...
$txt['permissiongroup_simple_make_unapproved_posts'] = 'Publicar temas y respuestas en el foro <span style="text-decoration: underline">sólo</span> después de que hayan sido aprobados';
...
$txt['permissionname_simple_post_unapproved_replies_own'] = 'Publicar respuestas en un tema - pero requieren la aprobación';
$txt['permissionname_simple_post_unapproved_replies_any'] = 'Publicar respuestas en cualquier tema - pero requieren la aprobación';
...
$txt['permissionname_simple_poll_add_own'] = 'Añadir una encuesta a un tema propio';
...
$txt['permission_by_board_desc'] = 'Puedes establecer cuándo un foro utiliza los permisos globales o tiene permisos específicos. Al utilizar permisos locales en el foro, puedes establecer cada permiso para cada grupo.';
...
$txt['permissions_post_moderation_desc'] = 'Desde esta página se puede cambiar fácilmente los grupos que tienen sus mensajes moderados para un perfil de permisos en particular.';
$txt['permissions_post_moderation_deny_note'] = 'Nota: Mientras tiene activado los permisos avanzados no se puede "Denegar permisos" de esta página. Por favor, modifique los permisos directamente si desea denegar permisos.';
...
$txt['permissions_post_moderation_moderate'] = 'Se puede crear pero con aprobación';
$txt['permissions_post_moderation_disallow'] = 'No se puede crear';
$txt['permissions_post_moderation_group'] = 'Grupo';

$txt['auto_approve_topics'] = 'Colocar mensajes, sin necesidad de aprobación';
$txt['auto_approve_replies'] = 'Responder a los mensajes, sin necesidad de aprobación';
$txt['auto_approve_attachments'] = 'Publicar archivos adjuntos, sin necesidad de aprobación';
