...
$txt['membergroups_edit_inherit_permissions_no'] = 'No - Usar Permisos Únicos';
...
$txt['membergroups_group_type_private'] = 'Privado <span class="smalltext">(La membresía debe ser asignada)</span>  ';
...
$txt['membergroups_group_type_request'] = 'Solicitable <span class="smalltext">(El usuario puede solicitar la membresía)</span>  ';
$txt['membergroups_group_type_free'] = 'Libre <span class="smalltext">(El usuario puede unirse y abandonar el grupo a gusto)</span>  ';
$txt['membergroups_group_type_post'] = 'Basado en Mensajes <span class="smalltext">(La membresía está basada en el conteo de mensajes)</span>  ';
...
$txt['membergroups_members_deadmin_confirm'] = 'Estás seguro que deseas removerte a ti mismo del grupo de Administración?';
...
$txt['admin_browse_awaiting_approval'] = 'Esperando Aprobación <span style="font-weight: normal">(%1$d)</span>';
$txt['admin_browse_awaiting_activate'] = 'Esperando Activación <span style="font-weight: normal">(%1$d)</span>';
...
$txt['admin_browse_no_members_approval'] = 'Ningún usuario está esperando aprobación.';
