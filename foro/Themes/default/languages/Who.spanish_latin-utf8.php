...
$txt['who_show_members_only'] = 'Solo Miembros';
$txt['who_show_guests_only'] = 'Solo Invitados';
$txt['who_show_spiders_only'] = 'Solo Arañas';
$txt['who_show_all'] = 'Todos';
$txt['who_no_online_spiders'] = 'No hay ninguna araña conectada.';
$txt['who_no_online_guests'] = 'No hay ningún invitado conectado.';
$txt['who_no_online_members'] = 'No hay ningún miembro conectado.';
...
$txt['whoall_activate'] = 'Activando sus cuentas.';
$txt['whoall_buddy'] = 'Modificando su lista de amigos.';
$txt['whoall_coppa'] = 'Completar el formulario de consentimiento del padre/tutor.';
$txt['whoall_credits'] = 'Viendo la página de créditos.';
$txt['whoall_emailuser'] = 'Enviando un email a otro miembro.';
$txt['whoall_groups'] = 'Viendo la página de grupos de miembros.';
...
$txt['whoall_modifykarma_applaud'] = 'Aplaudir a un usuario.';
$txt['whoall_modifykarma_smite'] = 'Abuchear a un usuario.';
...
$txt['whoall_openidreturn'] = 'Ingresando utilizando OpenID.';
...
$txt['whotopic_attachapprove'] = 'Aprovando archivo adjunto.';
...
$txt['whotopic_jsmodify'] = 'Modificando mensaje en "<a href="' . $scripturl . '?topic=%1$d.0">%2$s</a>".';
...
$txt['whotopic_sticky'] = 'Marcando el tema "<a href="' . $scripturl . '?topic=%1$d.0">%2$s</a>" como Fijo.';
...
$txt['whoadmin_featuresettings'] = 'Editando la config. de las modificaciones instaladas.';
...
$txt['whoallow_manageattachments'] = 'Manejando los archivos adjuntos.';
...
// Credits text
$txt['credits'] = 'Creditos';
$txt['credits_intro'] = 'Simple Machines quiere agradecer a todos los que ayudaron en hacer SMF 2.0 lo que es hoy; dandole forma y dirigiendo nuestro proyecto, a traves de los grueso y lo fino. No hubiera sido posible sin ti. Esto incluye a nuestros usuarios y especialmente a nuestros Miembros Charter - Gracias por instalar y usar nuestro software, dandonos información valuable, reporte de errores, y opiniones.';
$txt['credits_team'] = 'El Equipo';
$txt['credits_special'] = 'Agradecimientos Especiales';
$txt['credits_and'] = 'y';
$txt['credits_anyone'] = 'Y para todos los que olvidamos nombrar, gracias!';
...
$txt['credits_groups_support'] = 'Especialistas de Apoyo';
$txt['credits_groups_customize'] = 'Desarrolladores';
$txt['credits_groups_docs'] = 'Escritores de Documentacion';
$txt['credits_groups_marketing'] = 'Marketing ';
$txt['credits_groups_internationalizers'] = 'Localizadores';
$txt['credits_groups_servers'] = 'Administradores del servidor';
$txt['credits_groups_site'] = 'Administradores del sitio';
// Replace "English" with the name of this language pack in the string below.
$txt['credits_groups_translation'] = 'Traducción al Español';
$txt['credits_groups_translators'] = 'Traductores de Idioma';
$txt['credits_translators_message'] = 'Gracias por sus esfuerzos en hacer que las personas alrededor de todo el mundo usen SMF.';
$txt['credits_groups_consultants'] = 'Desarrolladores Consultores';
$txt['credits_groups_beta'] = 'Beta Testers ';
$txt['credits_beta_message'] = 'Aquellos pocos que incansablemente encuentran bugs, proveen retroalimentación y vuelven a los desarrolladores aún mas locos.';
$txt['credits_groups_founder'] = 'Padre Fundador de SMF';
$txt['credits_groups_orignal_pm'] = 'Gerente de Proyecto Original';
$txt['credits_in_memoriam'] = 'En recuerdo amoroso de';

// List of people who have made more than a token contribution to this translation. (blank for English)
$txt['translation_credits'] = array('^HeRaCLeS^', 'luuuciano', 'mirahalo', 'German_AC', 'enik', 'Rock Lee');
